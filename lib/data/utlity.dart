...
int total() {
  ...
  for (var i = 0; i < history2.length; i++) {
    try {
      ...
      print('Invalid amount format at index $i: ${history2[i].amount}');
      // Optionally, you can add a default value if the format is invalid:
      a.add(0); // Adds zero if the amount is invalid
    }
  }
  int totals = a.isNotEmpty ? a.reduce((value, element) => value + element) : 0;
